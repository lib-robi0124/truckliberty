        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueEUR = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conditions_Contracts_ContractId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Destinations_Conditions_ConditionId",
            ...
            migrationBuilder.InsertData(
                table: "Transporters",
                columns: new[] { "Id", "CompanyName", "ContactPerson", "Email", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "TransLogistika DOOEL", "Petar Petrovski", "info@translogistika.mk", "+389 70 123 456" },
                    { 2, "Balkan Transport Group", "Milan Jovanovic", "office@balkantransport.rs", "+381 64 987 6543" },
                    { 3, "EuroCargo Solutions", "Ivan Petrović", "contact@eurocargo.hr", "+385 91 332 4422" }
                });

            migrationBuilder.InsertData(
                table: "Contracts",
                columns: new[] { "Id", "ContractNumber", "CreatedDate", "TransporterId", "ValidUntil", "ValueEUR" },
                values: new object[,]
                {
                    { 1, "CTR-2025-001", new DateTime(2025, 1, 1, 10, 0, 0, 0, DateTimeKind.Unspecified), 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 15000.00m },
                    { 2, "CTR-2025-002", new DateTime(2025, 1, 2, 10, 0, 0, 0, DateTimeKind.Unspecified), 2, new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 12000.00m },
                    { 3, "CTR-2025-003", new DateTime(2025, 1, 3, 10, 0, 0, 0, DateTimeKind.Unspecified), 3, new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 18000.00m }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedDate", "FullName", "IsActive", "Password", "RoleId", "TransporterId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 10, 0, 0, 0, DateTimeKind.Unspecified), "System Admin", true, "admin123", 1, null },
                    { 2, new DateTime(2025, 1, 2, 12, 0, 0, 0, DateTimeKind.Unspecified), "Transporter User", true, "trans123", 2, 1 }
                });

            migrationBuilder.InsertData(
                table: "Conditions",
                columns: new[] { "Id", "ContractId", "ContractOilPrice" },
                values: new object[,]
                {
                    { 1, 1, 70.5m },
                    { 2, 2, 69.0m },
            ...
            migrationBuilder.InsertData(
                table: "Destinations",
                columns: new[] { "Id", "City", "ConditionId", "ContractId", "Country", "DailyPricePerLiter", "DestinationContractPrice" },
                values: new object[,]
                {
                    { 1, "Ljubljana", 1, null, "Slo", 70.0m, 150m },
                    { 2, "Zagreb", 1, null, "HR", 70.0m, 120m },
                    { 3, "Belgrade", 2, null, "SRB", 68.5m, 180m },
                    { 4, "Bucharest", 2, null, "RO", 68.5m, 200m },
                    { 5, "Sofia", 3, null, "BG", 71.0m, 175m },
                    { 6, "Thessaloniki", 3, null, "GR", 71.0m, 220m },
                    { 7, "Prishtina", 1, null, "RKS", 70.0m, 160m },
                    { 8, "Skopje", 2, null, "MK", 68.5m, 155m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Destinations_ConditionId",
                table: "Destinations",
                column: "ConditionId");
